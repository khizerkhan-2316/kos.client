    ...
    <div className="w-[87%] ml-[13%]">
      ...
      <div className='flex'>  
        ...
        >
          ...
          <Tooltip />
          <Legend />
          <Line yAxisId="left" type="monotone" dataKey="temperature" stroke="#8884d8" strokeWidth={3} activeDot={{ r: 8 }} name="Temperature (°C)" />
          <Line yAxisId="right" type="monotone" dataKey="co2Level" stroke="#82ca9d" strokeWidth={3} name="CO2 Level (ppm)" />
        </LineChart>
        </div>
